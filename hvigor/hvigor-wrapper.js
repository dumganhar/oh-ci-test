...
var D = d(e),
    ...
    b = {},
    _ = {},
    B = w && w.__importDefault || function (e) {
...
Object.defineProperty(_, "__esModule", {
    value: !0
}), _.isMac = _.isLinux = _.isWindows = void 0;
const P = B(E.default),
    k = "Windows_NT",
    x = "Linux",
    N = "Darwin";
...
var I = {},
    T = w && w.__createBinding || (Object.create ? function (e, t, n, r) {
        void 0 === r && (r = n);
    ...
    function (e) {
        var t = w && w.__createBinding || (Object.create ? function (e, t, n, r) {
            ...
            r = w && w.__importStar || function (e) {
                ...
                var r = {};
                if (null != e)
                    for (var u in e) "default" !== u && Object.prototype.hasOwnProperty.call(e, u) && t(r, e, u);
                return n(r, e), r
            };
...
j.hasNpmPackInPaths = function (e, t) {
    ...
    function (e) {
        ...
        e.checkNpmConifg = function () {
            ...
            }(), (0, s.executeCommand)(t, ["install", `pnpm@${e.PNPM_VERSION}`], {
...
var ae = function (e) {
    ue.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && function (e) {
        e.lchmod = function (t, n, r) {
            ...
            var r, u = e.openSync(t, ue.O_WRONLY | ue.O_SYMLINK, n),
                o = !0;
            try {
    ...
    e.lutimes || function (e) {
        ue.hasOwnProperty("O_SYMLINK") && e.futimes ? (e.lutimes = function (t, n, r, u) {
            ...
            var u, o = e.openSync(t, ue.O_SYMLINK),
                i = !0;
            try {
...
Pe.makeDir = async (e, t) => (Ie(e), Ne.mkdir(e, {
    mode: Te(t),
    recursive: !0
})), Pe.makeDirSync = (e, t) => (Ie(e), Ne.mkdirSync(e, {
    mode: Te(t),
    recursive: !0
}));
...
function Ye(e, t, n) {
    const r = n.dereference ? e => ze.stat(e, {
        bigint: !0
    }) : e => ze.lstat(e, {
        bigint: !0
    });
...
function Ze(e, t) {
    const n = Ke.resolve(e).split(Ke.sep).filter((e => e)),
        r = Ke.resolve(t).split(Ke.sep).filter((e => e));
...
var et = {
    checkPaths: function (e, t, n, r, u) {
        qe.callbackify(Ye)(e, t, r, ((r, o) => {
            ...
            return i.isDirectory() && Ze(e, t) ? u(new Error(Qe(e, t, n))) : u(null, {
                srcStat: i,
                destStat: s
            })
        }))
    ...
    checkPathsSync: function (e, t, n, r) {
        const {
            ...
            let r;
            const u = n.dereference ? e => ze.statSync(e, {
                    bigint: !0
                }) : e => ze.lstatSync(e, {
                    bigint: !0
                }),
...
var wt = function (e, t, n) {
    ...
    const {
        srcStat: r,
        destStat: u
    } = Ft.checkPathsSync(e, t, "copy", n);
    return Ft.checkParentPathsSync(e, r, t, "copy"),
        function (e, t, n, r) {
...
function xt(e, t, n) {
    let r = 0;
    "function" == typeof t && (n = t, t = {}), Bt(e, "rimraf: missing path"), Bt.strictEqual(typeof e, "string", "rimraf: path should be a string"), Bt.strictEqual(typeof n, "function", "rimraf: callback function required"), Bt(t, "rimraf: invalid options argument provided"), Bt.strictEqual(typeof t, "object", "rimraf: options should be object"), kt(t), Nt(e, t, (function u(o) {
        if (o) {
...
function Mt(e, t) {
    let n;
    kt(t = t || {}), Bt(e, "rimraf: missing path"), Bt.strictEqual(typeof e, "string", "rimraf: path should be a string"), Bt(t, "rimraf: missing options"), Bt.strictEqual(typeof t, "object", "rimraf: options should be object");
    try {
        n = t.lstatSync(e)
    } catch (n) {
    ...
    const r = (n = n || {}).overwrite || n.clobber || !1,
        {
            srcStat: u,
            isChangingCase: o = !1
        } = Ar.checkPathsSync(e, t, "move", n);
    return Ar.checkParentPathsSync(e, u, t, "move"),
        function (e) {
...
var wr, Or, br, _r, Br, Pr = {
        move: (0, re.fromCallback)(mr),
        moveSync: Sr
    },
    kr = {
        ...ne,
...
Jr = Nr, "undefined" == typeof process || "renderer" === process.type || !0 === process.browser || process.__nwjs ? Jr.exports = (Br || (Br = 1, function (e, t) {
    ...
    })(), t.colors = ["#0000CC", "#0000FF", "#0033CC", "#0033FF", "#0066CC", "#0066FF", "#0099CC", "#0099FF", "#00CC00", "#00CC33", "#00CC66", "#00CC99", "#00CCCC", "#00CCFF", "#3300CC", "#3300FF", "#3333CC", "#3333FF", "#3366CC", "#3366FF", "#3399CC", "#3399FF", "#33CC00", "#33CC33", "#33CC66", "#33CC99", "#33CCCC", "#33CCFF", "#6600CC", "#6600FF", "#6633CC", "#6633FF", "#66CC00", "#66CC33", "#9900CC", "#9900FF", "#9933CC", "#9933FF", "#99CC00", "#99CC33", "#CC0000", "#CC0033", "#CC0066", "#CC0099", "#CC00CC", "#CC00FF", "#CC3300", "#CC3333", "#CC3366", "#CC3399", "#CC33CC", "#CC33FF", "#CC6600", "#CC6633", "#CC9900", "#CC9933", "#CCCC00", "#CCCC33", "#FF0000", "#FF0033", "#FF0066", "#FF0099", "#FF00CC", "#FF00FF", "#FF3300", "#FF3333", "#FF3366", "#FF3399", "#FF33CC", "#FF33FF", "#FF6600", "#FF6633", "#FF9900", "#FF9933", "#FFCC00", "#FFCC33"], t.log = console.debug || console.log || (() => {}), e.exports = Rr()(t);
    const {
        formatters: n
    } = e.exports;
    n.j = function (e) {
        ...
        return r = function (e, t) {
            ...
            if (e)
                if ("-" === e.charAt(0))
                    ...
                    for (n = parseInt(e, 10); t.length < n;) t = ` ${t}`;
            return t
        }(n, r), r
    }
    return function (t) {
...
const {
    ...
    keys: Ou
} = Object, bu = String, _u = "string", Bu = {}, Pu = "object", ku = (e, t) => t, xu = e => e instanceof bu ? bu(e) : e, Nu = (e, t) => typeof t === _u ? new bu(t) : t, Iu = (e, t, n, r) => {
    const u = [];
    for (let o = Ou(n), {
            length: i
        } = o, s = 0; s < i; s++) {
...
class $u {
    constructor(e, t, n, r, u) {
        this.startTime = new Date, this.categoryName = e, this.data = n, this.level = t, this.context = Object.assign({}, r), this.pid = process.pid, u && (this.functionName = u.functionName, this.fileName = u.fileName, this.lineNumber = u.lineNumber, this.columnNumber = u.columnNumber, this.callStack = u.callStack)
    }
    serialise() {
...
var eo = {
        ...
        isMaster: Xu,
        send: e => {
            Xu() ? Zu(e) : (Ku || (e.cluster = {
                workerId: Wu.worker.id,
                worker: process.pid
            }), process.send({
...
oo.configure = function (e, t) {
    ...
    return e.layout && (n = t.layout(e.layout.type, e.layout)),
        function (e, t) {
            return n => {
                io(e(n, t))
            }
...
var bo = function e(t, n, r, u) {
    ...
    let o = n.mode;
    const i = n.fs || vo;
    void 0 === o && (o = Oo & ~process.umask()), u || (u = null), r = r || function () {}, t = So.resolve(t), i.mkdir(t, o, (o => {
...
function Ko(e, t) {
    const n = jo.resolve(e).split(jo.sep).filter((e => e)),
        r = jo.resolve(t).split(jo.sep).filter((e => e));
    return n.reduce(((e, t, n) => e && r[n] === t), !0)
}
...
var si = function (e, t, n) {
        ...
        const {
            srcStat: r,
            destStat: u
        } = ri.checkPathsSync(e, t, "copy");
        return ri.checkParentPathsSync(e, r, t, "copy"),
            function (e, t, n, r) {
                if (r.filter && !r.filter(t, n)) return;
...
function Ai(e, t, n, r, u) {
    return "function" == typeof di.copyFile ? di.copyFile(t, n, (t => t ? u(t) : vi(e, n, r, u))) : function (e, t, n, r, u) {
        ...
        o.on("error", (e => u(e))).once("open", (() => {
            const t = di.createWriteStream(n, {
                mode: e.mode
            });
...
function Ni(e, t, n) {
    let r = 0;
    "function" == typeof t && (n = t, t = {}), Pi(e, "rimraf: missing path"), Pi.strictEqual(typeof e, "string", "rimraf: path should be a string"), Pi.strictEqual(typeof n, "function", "rimraf: callback function required"), Pi(t, "rimraf: invalid options argument provided"), Pi.strictEqual(typeof t, "object", "rimraf: options should be object"), xi(t), Ii(e, t, (function u(o) {
        if (o) {
            if (("EBUSY" === o.code || "ENOTEMPTY" === o.code || "EPERM" === o.code) && r < t.maxBusyTries) {
                r++;
...
function Li(e, t) {
    let n;
    xi(t = t || {}), Pi(e, "rimraf: missing path"), Pi.strictEqual(typeof e, "string", "rimraf: path should be a string"), Pi(t, "rimraf: missing options"), Pi.strictEqual(typeof t, "object", "rimraf: options should be object");
    try {
        n = t.lstatSync(e)
    } catch (n) {
        if ("ENOENT" === n.code) return;
...
var tc = function (e, t, n) {
        const r = (n = n || {}).overwrite || n.clobber || !1,
            {
                srcStat: u
            } = Qs.checkPathsSync(e, t, "move");
        return Qs.checkParentPathsSync(e, u, t, "move"), Zs(qs.dirname(t)),
            function (e, t, n) {
...
var Oc = async (e, t, n) => {
    if (n = function (e) {
        ...
        if (await Sc.pathExists(e))
            if (vc(`moveAndMaybeCompressFile: moving file from ${e} to ${t} ${n.compress?"with":"without"} compress`), n.compress) await new Promise(((r, u) => {
                let o = !1;
                const i = Sc.createWriteStream(t, {
                    mode: n.mode,
                    flags: "wx"
                }).on("open", (() => {
                    o = !0;
...
const bc = Nr.exports("streamroller:RollingFileWriteStream"),
    ...
    Ic = ({
        ...
        return ({
            date: e,
            index: t
        }) => (Cc(`_formatFileName: date=${e}, index=${t}`), d.reduce(((n, r) => r(n, t, e)), s))
    },
    Tc = ({
        file: e,
        keepFileExt: t,
...
var jc = class extends Lc {
    constructor(e, t, n, r) {
        r || (r = {}), t && (r.maxSize = t), r.numBackups || 0 === r.numBackups || (n || 0 === n || (n = 1), r.numBackups = n), super(e, r), this.backups = r.numBackups, this.size = this.options.maxSize
    }
    get theStream() {
...
Eo.configure = function (e, t) {
    let n = t.basicLayout;
    return e.layout && (n = t.layout(e.layout.type, e.layout)), e.mode = e.mode || 384,
        function (e, t, n, r, u, o) {
...
ea.configure = function (e, t) {
    ...
    return function (e, t, n, r, u, o) {
        ...
        const i = function (e, t, n) {
            let r;
            var u;
            return t ? r = new ia(e, t, n, o) : (oa(u = e, o), r = {
                write(e) {
...
function Ta(e) {
    const t = _a.getLevel(e),
        n = t.toString().toLowerCase().replace(/_([a-z])/g, (e => e[1].toUpperCase())),
                    ...
                    const s = function (e, t, n) {
                        ...
                        return r.push({
                            ...
                            for (let e = 0; e < t.length; ++e)
                                for (let n = e + 1; n < t.length; ++n) t[e].token == t[n].token && t.splice(n--, 1);
                            return t
                        })(n.concat(r))
                    }(e, i, t.tokens || []);
...
al.getLevel = () => dl, al.levelMap = new Map([
    ["ALL", ll.levels.ALL],
    ["MARK", ll.levels.MARK],
...
var Dl = w && w.__createBinding || (Object.create ? function (e, t, n, r) {
    ...
    El = w && w.__importStar || function (e) {
        ...
        var t = {};
        if (null != e)
            for (var n in e) "default" !== n && Object.prototype.hasOwnProperty.call(e, n) && Dl(t, e, n);
        return pl(t, e), t
    };
Object.defineProperty(xr, "__esModule", {
    value: !0
}), xr.evaluateLogLevel = xr.HvigorLogger = void 0;
const ml = El(cl),
    hl = cl,
    yl = El(F.default),
    Cl = al;
...
Object.defineProperty(X, "__esModule", {
    value: !0
}), X.parseJsonText = X.parseJsonFile = void 0;
const Al = Z,
    vl = gl(kr),
    Sl = gl(p.default),
    wl = gl(E.default),
...
let _l, Bl, Pl, kl, xl, Nl, Il = "start",
    Tl = [],
    Rl = 0,
    Ml = 1,
    Ll = 0,
...
X.parseJsonFile = function (e, t = !1, n = "utf-8") {
    const r = vl.default.readFileSync(Sl.default.resolve(e), {
        encoding: n
    });
    try {
        return Gl(r, t)
...
function Zl() {
    ...
    if (jl && "object" == typeof e && (e._line = Ml, e._column = Ll), void 0 === kl) kl = e;
        ...
        Array.isArray(t) ? jl && "object" != typeof e ? t.push({
            ...
            _line: Ml,
            _column: Ll
        }) : t.push(e) : t[Pl] = jl && "object" != typeof e ? {
            value: e,
            _line: Ml,
            _column: Ll
        } : e
...
var rf = w && w.__createBinding || (Object.create ? function (e, t, n, r) {
    ...
    of = w && w.__importStar || function (e) {
        ...
        var t = {};
        if (null != e)
            for (var n in e) "default" !== n && Object.prototype.hasOwnProperty.call(e, n) && rf(t, e, n);
        return uf(t, e), t
    };
...
var mf = Y.isAllDependenciesInstalled = function () {
    ...
    for (const e in null == pf ? void 0 : pf.dependencies)
        if (!(0, ff.hasNpmPackInPaths)(e, [lf.HVIGOR_PROJECT_DEPENDENCIES_HOME]) || !hf(e, pf, Ef)) return !1;
    return !0
};
...
const Cf = {
    cwd: lf.HVIGOR_PROJECT_DEPENDENCIES_HOME,
    stdio: ["inherit", "inherit", "inherit"]
};
var Ff = Y.executeInstallHvigor = function () {
    ...
    try {
        cf.mkdirSync(lf.HVIGOR_PROJECT_DEPENDENCIES_HOME, {
            recursive: !0
        });
    ...
    }(), (0, ff.executeCommand)(lf.HVIGOR_WRAPPER_PNPM_SCRIPT_PATH, ["install", "--no-frozen-lockfile"], Cf) //cjh
};
...
sf = Y.cleanWorkSpace = function () {
    ...
    if (e && 0 !== e.length) {
        ...
        try {
            e.forEach((e => {
                cf.rmSync(af.resolve(lf.HVIGOR_PROJECT_DEPENDENCIES_HOME, e), {
                    recursive: !0
                })
            }))
        } catch (e) {
...
var vf = {},
    Sf = w && w.__createBinding || (Object.create ? function (e, t, n, r) {
        void 0 === r && (r = n);
        var u = Object.getOwnPropertyDescriptor(t, n);
        u && !("get" in u ? !t.__esModule : u.writable || u.configurable) || (u = {
            enumerable: !0,
    ...
    Of = w && w.__importStar || function (e) {
        ...
        var t = {};
        if (null != e)
            for (var n in e) "default" !== n && Object.prototype.hasOwnProperty.call(e, n) && Sf(t, e, n);
        return wf(t, e), t
    };
